...
from useq import GridRowsColumns, RandomPoints, RelativePosition, Shape
...
if TYPE_CHECKING:
    from pymmcore_widgets.useq_widgets.points_plans._points_plan_selector import (
        RelativePointPlan,
    )
...
class WellViewData:
    ...
    mode: RelativePointPlan | None = None
...
class WellView(ResizingGraphicsView):
    ...
    def setMode(self, mode: RelativePointPlan | None) -> None:
    ...
    def mode(self) -> RelativePointPlan | None:
    ...
    def _update_scene(self, value: RelativePointPlan | None) -> None:
