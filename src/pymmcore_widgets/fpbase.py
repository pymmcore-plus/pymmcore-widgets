...
class FPbaseFluorophore(BaseModel):
    """Represents a fluorophore on FPbase."""
    ...
    def default_state(self) -> State | None:
        """Return the default state of the fluorophore."""
...
class FilterPlacement(SpectrumOwner):
    """Represents a filter placement on FPbase."""
...
class OpticalConfig(BaseModel):
    """Represents an optical configuration on FPbase."""
...
class FPbaseMicroscope(BaseModel):
    """Represents a microscope configuration on FPbase."""
