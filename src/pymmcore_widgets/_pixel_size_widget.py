...
#     def __init__(self, core: CMMCorePlus, parent: Optional[QtW.QWidget] = None) -> None:  # noqa:E501
...
#                 self.table.cellWidget(r, IMAGE_PX_SIZE).setText(f"{_image_px_size:.4f}")  # noqa:E501
...
#         if self._is_read_only(IMAGE_PX_SIZE):
#             _image_px_size = self._calculate_image_px_size(camera_px_size.text(), value)  # noqa:E501
...
#             for cfg in self._mmc.getAvailablePixelSizeConfigs():
#                 cfg_data = list(itertools.chain(*self._mmc.getPixelSizeConfigData(cfg)))  # noqa:E501
